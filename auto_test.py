...
import random
import torch
from douzero.evaluation.auto_simu import evaluate
# 设置 random 模块的随机数种子
random.seed(78419)
# 设置 NumPy 的随机数种子
...
def main(checkpoint_dir, output_csv, output_all_csv, best_txt, dire, position):
    ...
    player_2_playcard = 'douzero_checkpoints/douzero/landlord_down_723200.ckpt'
    player_3_playcard = 'douzero_checkpoints/douzero/landlord_up_723200.ckpt'
